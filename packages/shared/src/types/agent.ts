...
export type GuruEvent =
  ...
  | { type: 'delegation_progress'; delegationId: string; toolUseId?: string; phase: 'tool_start' | 'tool_result' | 'assistant' | 'final'; toolName?: string; brief?: string; isError?: boolean; text?: string; title?: string; role?: string; parentToolUseId?: string; result?: string }
  // 自动任务会话被用户接管（毕业）
