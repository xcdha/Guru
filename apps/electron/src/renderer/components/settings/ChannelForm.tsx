...
import { normalizeBaseUrl, resolveAnthropicMessagesUrl, resolveOpenAIChatCompletionsUrl, resolveOpenAIResponsesUrl } from '@guru/core'
...
export function ChannelForm({ channel, onSaved, onCancel }: ChannelFormProps): React.ReactElement {
  ...
  const isSubscriptionProvider = isCodexProvider || isGithubCopilotProvider || isClaudeOAuthProvider || isXaiProvider
