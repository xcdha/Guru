...
import type { AgentStreamEvent, AgentStreamCompletePayload, AgentEvent, AgentStreamPayload, AgentAssistantDelta, AgentAssistantDeltaPayload, AgentStreamErrorPayload, SDKAssistantMessage, SDKMessage, SDKUserMessage, SDKSystemMessage, GuruEvent, AgentSessionMeta, ProviderType, SDKContentBlock, SDKUserContentBlock } from '@guru/shared'
import { inferContextWindow } from '@guru/shared'
import {
...
export function useGlobalAgentListeners(): void {
  ...
  useEffect(() => {
    ...
    const openPlanDocumentPreview = (sessionId: string, planDocument: NonNullable<import('@guru/shared').ExitPlanModeRequest['planDocument']>): void => {
    ...
    const queueExitPlanRequest = (request: import('@guru/shared').ExitPlanModeRequest): boolean => {
