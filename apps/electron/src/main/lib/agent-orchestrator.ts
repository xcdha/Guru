...
import { appendSDKMessages, updateAgentSessionMeta, getAgentSessionMeta, getAgentSessionMessages, truncateSDKMessages, removeSDKErrorMessage, updateSDKUserMessageSkillActivations, rewindPiAgentSession, getActiveWorktreePath } from './agent-session-manager'
import { getAgentWorkspace, getLocalProjectRootStatus, getEffectiveMcpConfig, getEffectiveSkillsDirs, getWorkspaceAutoMemoryDir, getWorkspaceAttachedDirectories, getWorkspaceAttachedFiles, getWorkspaceDefaultWorkingDirectory, getWorkspaceMemoryGuidance, isWorkspaceProjectKnowledgeMaintenanceApproved, hasProjectSkills, getProjectSkillsDir, getAgentDefaultWorkingDirectory } from './agent-workspace-manager'
import { resolveEffectivePluginScope } from './agent-plugin-profile'
import { getAgentWorkspacePath, getAgentSessionWorkspacePath, getWorkspaceFilesDir, getWorkspaceSkillsDir, getSdkConfigDir } from './config-paths'
...
export interface SessionCallbacks {
  ...
  onRunStarted?: (opts: { startedAt: number; userMessage?: string; userMessageUuid?: string }) => void
}
