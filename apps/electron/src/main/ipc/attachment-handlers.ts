/**
 * attachment-handlers — 从 src/main/ipc.ts 抽出的 IPC 处理器分组
 *
 * 抽取自 ipc.ts banner「附件管理相关」（2026-09-14 分批拆分）。整块搬移，未改 handler 逻辑。
 */

import { deleteAttachment, openFileDialog, readAttachmentAsBase64, saveAttachment } from '../lib/attachment-service'
...
import type { AttachmentSaveInput, AttachmentSaveResult, FileDialogResult } from '@guru/shared'
