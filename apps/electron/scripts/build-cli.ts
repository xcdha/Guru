...
const binName = isWindows ? 'guru.exe' : 'guru'
...
console.log(`${color.cyan}[build:cli]${color.reset} 编译 guru CLI → ${color.dim}${outFile}${color.reset}`)
